...
Step 1：将此项目下载到本地
```bash
$ git clone https://github.com/hiaihua2005/react-admin.git
```
...
React Admin is licensed under the [Apache License](https://github.com/hiaihua2005/react-admin/blob/master/LICENSE)
