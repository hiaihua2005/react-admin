...
export default class extends Component {
    ...
    componentDidMount() {
        ...
        // 开发时方便测试，填写表单
        if (process.env.NODE_ENV === 'development' || window.location.origin === 'http://www.huayisoft.com') {
            this.form.setFieldsValue({userName: 'admin', password: '12345678'});
        }
    ...
    handleSubmit = (values) => {
        ...
        this.props.ajax.post('/biz/user/login', params, {errorTip: false})
            .then(res => {
                if(res.code==0) {
